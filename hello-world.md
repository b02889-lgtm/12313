...
欢迎来到这个工作区！这里包含多个子项目和工具脚本，本文件帮助你快速了解各部分的用途。
...
- 📋 [变更提案目录](./spec-changes/) — 查看所有已规划的变更
- 📖 [项目总览](./README.md) — 详细的项目说明
- 📊 [数据分析脚本](./analyze_sample_data.py) — 示例数据分析
- 🌤️ [天气 MCP 服务](./weather-mcp-server/) — 天气查询工具

---

> 🔖 本文件由 Spec 流程验证生成（变更：`add-hello-world`）
1